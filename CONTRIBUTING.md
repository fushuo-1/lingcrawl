...
Welcome to [LingCrawl](https://lingcrawl.dev) 🔥! Here are some instructions on how to get the project locally, so you can run it on your own (and contribute)

If you're contributing, note that the process is similar to other open source repos i.e. (fork lingcrawl, make changes, run tests, PR). If you have any questions, and would like help getting on board, reach out to help@lingcrawl.com for more or submit an issue!
...
```bash
pnpm start
# if you are going to use the [llm-extract feature](https://github.com/lingcrawl/lingcrawl/pull/586/), you should also export OPENAI_API_KEY=sk-______
```

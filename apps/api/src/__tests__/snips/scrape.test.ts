...
describe("Scrape tests", () => {
  ...
  concurrentIf(ALLOW_TEST_SUITE_WEBSITE)(
    ...
    async () => {
      ...
      expect(response.markdown).toContain("LingCrawl");
    },
    scrapeTimeout,
  );
  ...
  concurrentIf(ALLOW_TEST_SUITE_WEBSITE)("images format works", async () => {
    ...
    // LingCrawl website should have at least the logo
    expect(response.images?.some(img => img.includes("lingcrawl"))).toBe(true);
  });

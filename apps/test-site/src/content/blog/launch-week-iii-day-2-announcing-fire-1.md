...
description: "LingCrawl's new FIRE-1 AI Agent enhances web scraping capabilities by intelligently navigating and interacting with web pages."
pubDate: "Apr 15, 2025"
...
FIRE-1 brings a new level of intelligence to LingCrawl, enhancing your scraping tasks by navigating complex website structures, interacting with dynamic content, and more. This powerful AI agent ensures comprehensive data extraction beyond traditional scraping methods.
...
```bash
curl -X POST https://api.lingcrawl.dev/v1/scrape \
  ...
  -d '{
    ...
    "agent": {
      "model": "FIRE-1",
      "prompt": "Search for lingcrawl and go to the company page."
    }
  }'
```
...
- **Explore the docs:** Learn more in our [comprehensive documentation](https://docs.lingcrawl.dev/agents/fire-1).
- **Need help?** Join our [Discord community](https://discord.gg/S7Enyh9Abh) or email [help@lingcrawl.com](mailto:help@lingcrawl.com).

**Ready to leverage AI-powered scraping?** [Sign up for LingCrawl](https://lingcrawl.dev/signup) and start with FIRE-1 today.

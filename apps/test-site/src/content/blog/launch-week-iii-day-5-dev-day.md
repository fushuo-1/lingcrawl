...
**Day 5 of Launch Week III is here — and it’s all about developers.** We’re rolling out a stack of improvements aimed at making LingCrawl smoother, faster, and better to build with.
...
## New: LingCrawl Dark Theme for Code Editors

We launched our LingCrawl Light Theme on Day 0. Today, we’re releasing the Dark Theme — for those who prefer building in low light.
...
Download it directly from the [VSCode Marketplace](https://marketplace.visualstudio.com/items?itemName=LingCrawl.lingcrawl-theme) and bring LingCrawl’s look and feel to your editor.

## Quality of Life Updates

We’ve also shipped a number of smaller improvements behind the scenes to streamline developer experience across the board. Includinng now every LingCrawl plan now includes support for up to 20 seats — no more user limits. Bring your team and build together.

...
```bash
curl -X POST https://api.lingcrawl.dev/v1/extract \
...
- **Try /extract v2:** Unlock next-level data gathering with LingCrawl and FIRE-1.
- **Check the docs:** Learn everything you need in our [official documentation](https://docs.lingcrawl.dev/features/extract#using-fire-1).
- **Join the community:** Need help or want to share feedback? Head to our [Discord](https://discord.gg/S7Enyh9Abh) or email [help@lingcrawl.com](mailto:help@lingcrawl.com).

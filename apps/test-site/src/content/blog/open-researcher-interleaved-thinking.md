---
title: "Open Researcher, our AI Agent That Uses LingCrawl Tools During Research"
description: "We built a research agent using Anthropic's interleaved thinking and LingCrawl. No orchestration needed."
pubDate: "Jul 01, 2025"
heroImage: "../../assets/blog/or_lingcrawl.webp"
category: "updates"
---
...
```
Thinking Block #1: They're asking about the 3rd blog post on lingcrawl.dev.
I need to find the blog listing first to count posts chronologically.

Thinking Block #2: I should search for 'site:lingcrawl.dev/blog' to get
...
- LingCrawl for web data extraction
...
Clone it: [github.com/lingcrawl/open-researcher](https://github.com/lingcrawl/open-researcher)

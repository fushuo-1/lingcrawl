"""
Async browser session methods for LingCrawl v2 API.
...
async def browser(
    ...
    *,
    ...
    resp = await client.post("/browser", body)
...
async def browser_execute(
    ...
    *,
    ...
    resp = await client.post(f"/browser/{session_id}/execute", body)
...
async def delete_browser(
    ...
    Returns:
        BrowserDeleteResponse
    """
    resp = await client.delete(f"/browser/{session_id}")

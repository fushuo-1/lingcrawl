...
class LingCrawlError(Exception):
    """Base exception for LingCrawl API errors."""
...
class BadRequestError(LingCrawlError):
    """Raised when the request is invalid (400)."""
    pass



class UnauthorizedError(LingCrawlError):
    """Raised when the request is unauthorized (401)."""
    pass


class PaymentRequiredError(LingCrawlError):
    """Raised when payment is required (402)."""
    pass


class WebsiteNotSupportedError(LingCrawlError):
    """Raised when website is not supported (403)."""
    pass


class RequestTimeoutError(LingCrawlError):
    """Raised when request times out (408)."""
    pass


class RateLimitError(LingCrawlError):
    """Raised when the rate limit is exceeded (429)."""
    pass


class InternalServerError(LingCrawlError):
...
def handle_response_error(response: requests.Response, action: str) -> None:
    ...
    if response.status_code == 400:
        ...
        raise LingCrawlError(message, response.status_code, response)
...
import pytest
from lingcrawl.types import Viewport, ScreenshotAction, Document
...
class TestScrapeE2E:
    ...
    def test_scrape_minimal(self):
        ...
        doc = self.client.scrape("https://docs.lingcrawl.dev")
    ...
    def test_scrape_images_format(self):
        ...
        assert any("lingcrawl" in img.lower() or "logo" in img.lower() for img in doc.images)

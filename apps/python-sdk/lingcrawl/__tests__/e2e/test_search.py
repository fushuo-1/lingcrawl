...
from lingcrawl.types import SearchData, Document, ScrapeOptions, SearchResultWeb, SearchResultNews, SearchResultImages

load_dotenv()

lingcrawl = LingCrawl(api_key=os.getenv("API_KEY"), api_url=os.getenv("API_URL"))
...
def _is_document(entry) -> bool:
    try:
        from lingcrawl.types import Document
...
def test_search_with_sources():
    ...
    assert 'lingcrawl' in all_web_text
...
def test_search_all_parameters():
    ...
    from lingcrawl.types import ScrapeOptions, JsonFormat, Location, WaitAction
    ...
    results = lingcrawl.search(
        ...
        scrape_options=ScrapeOptions(
            ...
            headers={"User-Agent": "LingCrawl-Test/1.0"},
...
def test_search_formats_flexibility():
    ...
    from lingcrawl.types import ScrapeFormats
    
    # Test with list format
    results1 = lingcrawl.search(

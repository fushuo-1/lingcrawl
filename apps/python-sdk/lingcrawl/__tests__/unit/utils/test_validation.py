import pytest
from lingcrawl.types import JsonFormat, ScrapeOptions, PDFParser
from lingcrawl.utils.validation import validate_scrape_options, prepare_scrape_options
...
class TestPrepareScrapeOptions:
    ...
    def test_prepare_new_v2_fields(self):
        ...
        from lingcrawl.types import Viewport, ScreenshotAction

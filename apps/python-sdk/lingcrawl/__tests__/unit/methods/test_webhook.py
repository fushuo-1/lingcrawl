"""
Unit tests for webhook functionality in LingCrawl v2 SDK.
"""

import pytest
from lingcrawl.types import WebhookConfig, CrawlRequest
from lingcrawl.methods.crawl import _prepare_crawl_request

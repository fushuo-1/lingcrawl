...
from lingcrawl.client_async import AsyncLingCrawlClient
from lingcrawl.utils.http_client_async import AsyncHttpClient
from lingcrawl.utils.http_client import HttpClient
from lingcrawl.methods.aio import batch as aio_batch
...
async def test_scrape_concurrency(monkeypatch):
    ...
    client = AsyncLingCrawlClient(api_key="test", api_url="http://localhost")

    start = time.perf_counter()
    await asyncio.gather(
        client.scrape("https://lingcrawl.dev"),
        client.scrape("https://lingcrawl.dev"),
        client.scrape("https://lingcrawl.dev")
    )

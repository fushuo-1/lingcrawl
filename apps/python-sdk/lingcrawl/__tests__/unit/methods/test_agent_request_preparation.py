...
from lingcrawl.methods.agent import _prepare_agent_request
from lingcrawl.types import AgentWebhookConfig
...
class TestAgentRequestPreparation:
    ...
    def test_basic_request_preparation(self):
        ...
        assert data["prompt"] == "Find information about LingCrawl"

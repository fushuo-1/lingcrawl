...
from lingcrawl import LingCrawlApp
...
class TestAgent(unittest.TestCase):
    ...
    @patch('lingcrawl.v2.utils.http_client.requests.post')
    @patch('lingcrawl.v2.utils.http_client.requests.get')
    def test_agent_basic(self, mock_get, mock_post):
        ...
        app = LingCrawlApp(api_key="test-api-key")
        result = app.agent(
        ...
        assert request_body["prompt"] == "Find the founders of LingCrawl"
    ...
    def test_agent_url_construction(self, mock_get, mock_post):
        ...
        app = LingCrawlApp(api_key="test-api-key", api_url="https://api.lingcrawl.dev")

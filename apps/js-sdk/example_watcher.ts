/*
 Advanced watcher example using the v2 LingCrawlClient.

 Run with:
   node --env-file=.env -r esbuild-register apps/js-sdk/lingcrawl/src/examples/watcher.ts
 or compile with your bundler, ensuring LINGCRAWL_API_KEY is set.
*/

import { LingCrawlClient } from "./lingcrawl/src/v2/client";

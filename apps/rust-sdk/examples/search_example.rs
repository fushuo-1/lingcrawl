...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    match args.example {
        Examples::All => {
            run_basic_example(&lingcrawl).await?;
            run_advanced_example(&lingcrawl).await?;
            run_geographic_example(&lingcrawl).await?;
            run_temporal_example(&lingcrawl).await?;
            run_social_example(&lingcrawl).await?;
            run_news_example(&lingcrawl).await?;
            run_academic_example(&lingcrawl).await?;
            run_commercial_example(&lingcrawl).await?;
        }
        Examples::Basic => run_basic_example(&lingcrawl).await?,
        Examples::Advanced => run_advanced_example(&lingcrawl).await?,
        Examples::Geo => run_geographic_example(&lingcrawl).await?,
        Examples::Temporal => run_temporal_example(&lingcrawl).await?,
        Examples::Social => run_social_example(&lingcrawl).await?,
        Examples::News => run_news_example(&lingcrawl).await?,
        Examples::Academic => run_academic_example(&lingcrawl).await?,
        Examples::Commercial => run_commercial_example(&lingcrawl).await?,
    }

    Ok(())
}
async fn run_basic_example(lingcrawl: &LingCrawlApp) -> Result<(), Box<dyn Error>> {
    let query = "rust programming language";
    let results = lingcrawl.search(query, None).await?;
    print_results("Basic Search", query, &results);
    Ok(())
}

async fn run_advanced_example(lingcrawl: &LingCrawlApp) -> Result<(), Box<dyn Error>> {
    ...
    let results = lingcrawl.search_with_params(params).await?;
    print_results("Advanced Repository Search", query, &results);
    Ok(())
}

async fn run_geographic_example(lingcrawl: &LingCrawlApp) -> Result<(), Box<dyn Error>> {
...
async fn run_temporal_example(lingcrawl: &LingCrawlApp) -> Result<(), Box<dyn Error>> {
...
async fn run_social_example(lingcrawl: &LingCrawlApp) -> Result<(), Box<dyn Error>> {
...
async fn run_news_example(lingcrawl: &LingCrawlApp) -> Result<(), Box<dyn Error>> {
    let query =
...
async fn run_academic_example(lingcrawl: &LingCrawlApp) -> Result<(), Box<dyn Error>> {
...
async fn run_commercial_example(lingcrawl: &LingCrawlApp) -> Result<(), Box<dyn Error>> {

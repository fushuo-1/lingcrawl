...
async fn main() {
    ...
    // let app = LingCrawlApp::new_selfhosted("http://localhost:3002", None).expect("Failed to initialize LingCrawlApp");
    ...
    // Map a website (Alpha)
    let map_result = app.map_url("https://lingcrawl.dev", None).await;

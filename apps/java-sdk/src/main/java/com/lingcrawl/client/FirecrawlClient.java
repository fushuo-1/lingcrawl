package com.lingcrawl.client;

import com.lingcrawl.errors.LingCrawlException;
import com.lingcrawl.errors.JobTimeoutException;
...
/**
 * Client for the LingCrawl v2 API.
 *
 * <p>Example usage:
 * <pre>{@code
 ...
 * }</pre>
 */
public class LingCrawlClient {

    private static final String DEFAULT_API_URL = "https://api.lingcrawl.dev";
    ...
    private final LingCrawlHttpClient http;
    private final Executor asyncExecutor;

    private LingCrawlClient(LingCrawlHttpClient http, Executor asyncExecutor) {
        this.http = http;
        this.asyncExecutor = asyncExecutor;
    }

    /**
     * Creates a new builder for constructing a LingCrawlClient.
     */
    ...
    /**
     * Creates a client from the LINGCRAWL_API_KEY environment variable.
     */
    public static LingCrawlClient fromEnv() {
        String apiKey = System.getenv("LINGCRAWL_API_KEY");
        if (apiKey == null || apiKey.isBlank()) {
            String sysProp = System.getProperty("lingcrawl.apiKey");
            if (sysProp == null || sysProp.isBlank()) {
                throw new LingCrawlException("LINGCRAWL_API_KEY environment variable or lingcrawl.apiKey system property is required");
            }
            apiKey = sysProp;
        }
    ...
    public Document scrape(String url, ScrapeOptions options) {
        ...
        return extractData(http.post("/scrape", body, Map.class), Document.class);
    }
    ...
    public CrawlResponse startCrawl(String url, CrawlOptions options) {
        ...
        return http.post("/crawl", body, CrawlResponse.class);
    }
    ...
    public CrawlJob getCrawlStatus(String jobId) {
        ...
        return http.get("/crawl/" + jobId, CrawlJob.class);
    }
    ...
    public Map<String, Object> cancelCrawl(String jobId) {
        Objects.requireNonNull(jobId, "Job ID is required");
        return http.delete("/crawl/" + jobId, Map.class);
    }
    ...
    public Map<String, Object> getCrawlErrors(String jobId) {
        Objects.requireNonNull(jobId, "Job ID is required");
        return http.get("/crawl/" + jobId + "/errors", Map.class);
    }
    ...
    public BatchScrapeResponse startBatchScrape(List<String> urls, BatchScrapeOptions options) {
        ...
        return http.post("/batch/scrape", body, BatchScrapeResponse.class, extraHeaders);
    }
    ...
    public BatchScrapeJob getBatchScrapeStatus(String jobId) {
        Objects.requireNonNull(jobId, "Job ID is required");
        return http.get("/batch/scrape/" + jobId, BatchScrapeJob.class);
    }
    ...
    public Map<String, Object> cancelBatchScrape(String jobId) {
        Objects.requireNonNull(jobId, "Job ID is required");
        return http.delete("/batch/scrape/" + jobId, Map.class);
    }
    ...
    public MapData map(String url, MapOptions options) {
        ...
        return extractData(http.post("/map", body, Map.class), MapData.class);
    }
    ...
    public SearchData search(String query, SearchOptions options) {
        ...
        return extractData(http.post("/search", body, Map.class), SearchData.class);
    }
    ...
    public AgentResponse startAgent(AgentOptions options) {
        ...
        return http.post("/agent", options, AgentResponse.class);
    }
    ...
    public AgentStatusResponse getAgentStatus(String jobId) {
        Objects.requireNonNull(jobId, "Job ID is required");
        return http.get("/agent/" + jobId, AgentStatusResponse.class);
    }
    ...
    public AgentStatusResponse agent(AgentOptions options, int pollIntervalSec, int timeoutSec) {
        ...
        if (start.getId() == null) {
            throw new LingCrawlException("Agent start did not return a job ID");
        }
    ...
    public Map<String, Object> cancelAgent(String jobId) {
        Objects.requireNonNull(jobId, "Job ID is required");
        return http.delete("/agent/" + jobId, Map.class);
    }
    ...
    public BrowserCreateResponse browser(Integer ttl, Integer activityTtl, Boolean streamWebView) {
        ...
        return http.post("/browser", body, BrowserCreateResponse.class);
    }
    ...
    public BrowserExecuteResponse browserExecute(String sessionId, String code,
        ...
        return http.post("/browser/" + sessionId + "/execute", body, BrowserExecuteResponse.class);
    }
    ...
    public BrowserDeleteResponse deleteBrowser(String sessionId) {
        Objects.requireNonNull(sessionId, "Session ID is required");
        return http.delete("/browser/" + sessionId, BrowserDeleteResponse.class);
    }
    ...
    public ConcurrencyCheck getConcurrency() {
        return http.get("/concurrency-check", ConcurrencyCheck.class);
    }
    ...
    public CreditUsage getCreditUsage() {
        return http.get("/team/credit-usage", CreditUsage.class);
    }
    ...
    private void sleep(int seconds) {
        try {
            ...
            throw new LingCrawlException("Polling interrupted", e);
        }
    }
    ...
    public static final class Builder {
        ...
        /**
         * Sets the API key. Falls back to LINGCRAWL_API_KEY env var or
         * lingcrawl.apiKey system property if not provided.
         */
        ...
        /**
         * Sets the API base URL. Defaults to https://api.lingcrawl.dev.
         * Falls back to LINGCRAWL_API_URL env var if not provided.
         */
        ...
        public LingCrawlClient build() {
            String resolvedKey = apiKey;
            if (resolvedKey == null || resolvedKey.isBlank()) {
                resolvedKey = System.getenv("LINGCRAWL_API_KEY");
            }
            if (resolvedKey == null || resolvedKey.isBlank()) {
                resolvedKey = System.getProperty("lingcrawl.apiKey");
            }
            if (resolvedKey == null || resolvedKey.isBlank()) {
                throw new LingCrawlException(
                        "API key is required. Set it via builder.apiKey(), " +
                        "LINGCRAWL_API_KEY environment variable, or lingcrawl.apiKey system property.");
            }

            String resolvedUrl = apiUrl;
            if (resolvedUrl == null || resolvedUrl.equals(DEFAULT_API_URL)) {
                String envUrl = System.getenv("LINGCRAWL_API_URL");
            ...
            LingCrawlHttpClient http = new LingCrawlHttpClient(
                    resolvedKey, resolvedUrl, timeoutMs, maxRetries, backoffFactor);
            return new LingCrawlClient(http, executor);
        }
    }
}

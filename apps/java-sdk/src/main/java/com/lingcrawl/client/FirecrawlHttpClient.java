...
import com.lingcrawl.errors.AuthenticationException;
import com.lingcrawl.errors.LingCrawlException;
import com.lingcrawl.errors.RateLimitException;
import okhttp3.*;
...
/**
 * Internal HTTP client for making authenticated requests to the LingCrawl API.
 * Handles retry logic with exponential backoff.
 */
class LingCrawlHttpClient {
    ...
    LingCrawlHttpClient(String apiKey, String baseUrl, long timeoutMs, int maxRetries, double backoffFactor) {
        this.apiKey = apiKey;
    ...
    <T> T post(String path, Object body, Class<T> responseType, Map<String, String> extraHeaders) {
        ...
        try {
            ...
            throw new LingCrawlException("Failed to serialize request body", e);
        }
            ...
            try {
                try (Response response = httpClient.newCall(request).execute()) {
                    ...
                    if (code >= 400 && code < 500 && code != 408 && code != 409) {
                        throw new LingCrawlException(errorMessage, code, errorCode, null);
                    }
                ...
                throw new LingCrawlException("Request failed: " + e.getMessage(), e);
            }
        }
    }
    ...
    private void sleepWithBackoff(int attempt) {
        ...
        try {
            ...
            throw new LingCrawlException("Request interrupted during retry backoff", e);
        }
    }
}

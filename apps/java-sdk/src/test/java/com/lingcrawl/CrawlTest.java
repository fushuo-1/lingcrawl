 ...
 * 
 * Run with: LINGCRAWL_API_KEY=fc-xxx gradle test --tests "com.lingcrawl.CrawlTest"
 */
class CrawlTest {
    ...
    void testStartCrawlMinimal() {
        ...
        CrawlResponse response = client.startCrawl("https://docs.lingcrawl.dev",
    ...
    void testGetCrawlStatus() {
        ...
        // Start a crawl
        CrawlResponse start = client.startCrawl("https://docs.lingcrawl.dev",
                CrawlOptions.builder()
                        .limit(3)
                        .build());
    ...
    void testCrawlWithWait() {
        ...
        CrawlJob job = client.crawl("https://lingcrawl.dev",
                CrawlOptions.builder()
                        .limit(3)
                        .maxDiscoveryDepth(1)
                        .build(),
    ...
    void testCrawlWithWebhookConfig() {
        ...
        try {
            ...
            CrawlResponse response = client.startCrawl("https://lingcrawl.dev",
                    CrawlOptions.builder()
                            .limit(2)
    ...
    @Test
    @EnabledIfEnvironmentVariable(named = "LINGCRAWL_API_KEY", matches = ".*\\S.*")
    void testCrawlLingCrawlHomepage() {
        System.out.println("\n=== Test: Crawl LingCrawl.dev Homepage ===");
        ...
        // Verify content from LingCrawl site
        boolean hasLingCrawlContent = job.getData().stream()
                .anyMatch(doc -> {
                    String markdown = doc.getMarkdown();
                    return markdown != null && 
                           (markdown.toLowerCase().contains("lingcrawl") ||
                            markdown.toLowerCase().contains("scrape") ||
                            markdown.toLowerCase().contains("crawl"));
                });
        
        assertTrue(hasLingCrawlContent, "Should contain LingCrawl-related content");
        
        System.out.println("✓ Successfully crawled LingCrawl homepage");

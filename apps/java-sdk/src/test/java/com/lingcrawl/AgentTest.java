...
import com.lingcrawl.models.AgentOptions;
import com.lingcrawl.models.AgentResponse;
import com.lingcrawl.models.AgentStatusResponse;
 ...
 * 
 * Run with: LINGCRAWL_API_KEY=fc-xxx gradle test --tests "com.lingcrawl.AgentTest"
 */
class AgentTest {
    ...
    void testAgentWithPrompt() {
        ...
        AgentStatusResponse result = client.agent(
                AgentOptions.builder()
                        .prompt("Find information about LingCrawl's main features and pricing")
                        .build());
    ...
    void testAgentWithURLs() {
        ...
        AgentStatusResponse result = client.agent(
                AgentOptions.builder()
                        .urls(List.of("https://lingcrawl.dev", "https://docs.lingcrawl.dev"))
                        .prompt("What are the main features of LingCrawl?")
                        .build());
    ...
    void testAgentWithSchema() {
        ...
        AgentStatusResponse result = client.agent(
                AgentOptions.builder()
                        .urls(List.of("https://lingcrawl.dev"))
    ...
    void testStartAgent() {
        ...
        AgentResponse response = client.startAgent(
                AgentOptions.builder()
                        .prompt("Research LingCrawl features")
                        .build());
    ...
    void testAgentWithStrictURLConstraints() {
        ...
        AgentStatusResponse result = client.agent(
                AgentOptions.builder()
                        .urls(List.of("https://docs.lingcrawl.dev"))
    ...
    void testAgentWithMaxCredits() {
        ...
        AgentStatusResponse result = client.agent(
                AgentOptions.builder()
                        .prompt("Quick research on LingCrawl")
                        .maxCredits(10)
                        .build());
    ...
    void testAgentResearchTask() {
        System.out.println("\n=== Test: Agent Research - LingCrawl Features ===");
        
        AgentStatusResponse result = client.agent(
                AgentOptions.builder()
                        .urls(List.of("https://lingcrawl.dev", "https://docs.lingcrawl.dev"))
                        .prompt("Research and summarize the key features of LingCrawl, including scraping, crawling, and extraction capabilities")
                        .build());

...
import com.lingcrawl.models.BrowserCreateResponse;
import com.lingcrawl.models.BrowserDeleteResponse;
import com.lingcrawl.models.BrowserExecuteResponse;
import com.lingcrawl.models.BrowserListResponse;
 ...
 *
 * Tests the browser session management functionality of the LingCrawl Java SDK.
 * These tests require LINGCRAWL_API_KEY environment variable to be set.
 *
 * Run with: LINGCRAWL_API_KEY=fc-xxx gradle test --tests "com.lingcrawl.BrowserTest"
 */
class BrowserTest {
    ...
    void testBrowserExecuteRequiresSessionId() {
        LingCrawlClient testClient = LingCrawlClient.builder()
                .apiKey("fc-test-key")
                .build();

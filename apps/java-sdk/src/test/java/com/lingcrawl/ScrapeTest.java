 ...
 * 
 * Tests the scrape functionality of the LingCrawl Java SDK.
 * These tests require LINGCRAWL_API_KEY environment variable to be set.
 * 
 * Run with: LINGCRAWL_API_KEY=fc-xxx gradle test --tests "com.lingcrawl.ScrapeTest"
 */
class ScrapeTest {
        ...
        assertThrows(LingCrawlException.class, () -> {
            client.scrape("not-a-valid-url",
                    ScrapeOptions.builder()
                            .formats(List.of("markdown"))
                            .build());
        }, "Should throw LingCrawlException for invalid URL");
